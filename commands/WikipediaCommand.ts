...
export class WikipediaCommand implements ISlashCommand {
  ...
  public i18nParamsExample = "wikipedia-slash-commands";
  public i18nDescription = "wikipedia-slash-description";
    ...
    try {
      ...
      switch (command) {
        case CommandsEnum.RANDOM:
          await wikipediaRandomCommand.run({
            app: this.app,
            context,
            read,
            http,
        ...
        case CommandsEnum.SEARCH:
          await wikipediaSearchCommand.run({
            app: this.app,
            context,
            read,
            http,
